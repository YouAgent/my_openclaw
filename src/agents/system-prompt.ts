...
export function buildAgentSystemPrompt(params: {
  ...
  /** User-configured persona rules injected early in the prompt (before workspace files). */
  personaRules?: string;
}) {
  ...
  const lines = [
    ...
    "",
    ...safetySection,
    ...(params.personaRules?.trim()
      ? ["## Persona Rules (mandatory)", params.personaRules.trim(), ""]
      : []),
